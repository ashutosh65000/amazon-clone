        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-3 col-sm-4">
            <div class="leftCol">
              ...
              <div class="imgBlock">
                <div class="eBooksimg">
                  <img :src="product.photo" class="img-fluid" style="height:350px;" />
                </div>
              </div>
            ...
            <div class="centerCol">
              ...
              <div class="bylineinfo">
                ...
                <a href="#" class="authorName">
                  {{product.owner.name}}
                  <i style="font-size: 8px !important; color: #555 !important;"></i>
                </a> (Author)
              </div>
                      ...
                      <span class="a-list-item">
                        ...
                        <span class="tmm-olp-links">
                          <a href="#" class="a-size-mini">
                            <span class="kcpAppBox">
                              <span class="a-declarative">
                                <span class="a-text-bold">Free App</span> with your Audible Trial</span>
                            </span>
                          </a>
                        </span>
                      </span>
                  ...
                  <div class="a-spacing-top-small">
                    <div class="a-section a-spacing-none">
                      <div class="a-section a-spacing-none a-spacing-top-mini">
                        This item shipts to
                        <b>Lucknow, India</b>
                        <b>Get it by Saturday, Aug. 15 - Friday, Aug. 21</b>
                ...
                <span class="a-declarative">
                  <a href="#" class="a-link-normal">
                    <div class="a-row a-spacing-mini">
                      ...
                      <span class="a-size-small">Deliver to Lucknow</span>
                    </div>
                  </a>
                </span>
                <br />
